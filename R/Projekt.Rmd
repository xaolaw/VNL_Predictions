...
Można na podstawie tej części wyników zobaczyć, że Polska drużyna radziła sobie w tamtych czasach najlepiej, poprzez najmniejszy współczynnik przy Versus oraz największy przy Nationality (spośród wartości wpływających na wynik).
Można porównać współczynniki w przypadku Nationality i Versus, ponieważ obrazują one te same dane i są proporcjonalne do siebie.
